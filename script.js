...
function sendMessage() {
  ...
  function getBotResponse(input) {
    ...
    if (msg.includes('notícia') || msg.includes('novidade')) return 'Últimas notícias em: https://draft5.gg/equipe/330-FURIA'
    ...
    if (msg.includes('história') || msg.includes('sobre')) return 'A FURIA foi fundada em 2017 e é um dos maiores times brasileiros de CS:GO!'
